"""
NOVA Runtime - Container runtime for NOVA images
"""
...
class NovaRuntime:
    """NOVA container runtime"""
    
    def __init__(self, debug: bool = False):
        self.debug = debug
        self.containers = {}
        self.images_dir = Path.home() / '.nova' / 'images'
